...
"""
This module contains the JSON schemas necessary to perform the validation of the different call/tasks performed by each LLM.
...
from utils.constants import (
    UNI_EDU_LEVELS, FORMA_MENTIS_CUES, EMPLOYMENT_STATUS,
    GENDER_LEVELS, SEXUAL_ORIENTATION, MARITAL_STATUS,
    MIGRATION_STATUS, RELIGIOUS_BELIEFS, MAPPING_CALL1_QUESTIONS
)
